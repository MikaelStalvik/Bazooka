...
namespace GroundControl
{
    public partial class MainForm : Form
    {
        ...
        private void pnlDraw_Paint(object sender, PaintEventArgs e)
        {
            ...
            var headerFont = new Font("Courier New", 6, FontStyle.Regular);
            ...
            for (int iColumn = 0; iColumn < columnsCount; iColumn++)
            {
                ...
                //var idx = column.Name.IndexOf(":");
                //var groupName = idx != -1 ? column.Name.Substring(0, idx) : string.Empty;
                //Debug.WriteLine(groupName);


                // Draw column name
                var idx = column.Name.IndexOf(":");
                var stripped = idx == -1 ? column.Name : column.Name.Substring(idx + 1);
                g.DrawString(stripped, headerFont, Brushes.White, titleRect.Expand(top: +0, left: -3), sfNear);
            }
        ...
        private void insert8ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var kl = m_Tracks;
            var mn = m_ColumnToTrack;
            var cy = m_Cursor.Y;
            var cx = m_Cursor.X;
